const id = "reference/example.md";
						...
						const _internal = {
							type: 'content',
							filePath: "/root/M7_doc/src/content/docs/reference/example.md",
							rawData: undefined,
						};
